...
//  have  an array they are trying to sort
let divsArray = [];
// have a speed factor
...
* --------------------------------------------------------------------------------
*
* this is a mergeSort feature
*
* --------------------------------------------------------------------------------
*/
export async function mergeSort(inArr, divStart = 0, divEnd = divsArray.length - 1 ) {
  //array produced from randomizing
  let arr = [...inArr];
...
* --------------------------------------------------------------------------------
*
* this is a insertionSort feature
*
* --------------------------------------------------------------------------------
*/
